...
class RoutineConfigDataProvider extends AbstractExpandableDataProvider {
    ...
    public RoutineConfigDataProvider(List<Pair<GroupData, List<ChildData>>> mData) {
        this.mData = mData;
    }
    ...
    public long addGroupItem(int splitId, String title) {
        ...
        final RoutineConfigDataProvider.ConcreteGroupData group =
                new RoutineConfigDataProvider.ConcreteGroupData(groupId, splitId, title);
    ...
    @Override
    public long addChildItem(int groupPosition, String text, int exerciseId) {
        int childId = mData.get(groupPosition).second.size();
        ChildData childData = new ConcreteChildData(childId, text);
    ...
    @Override
    public long setChildItem(int groupPosition, int childPosition, String text, int exerciseId) {
        mData.get(groupPosition).second.remove(childPosition);
        mData.get(groupPosition).second.add(childPosition, new ConcreteChildData(childPosition, text));
    ...
    public static final class ConcreteChildData extends ChildData {
        ...
        ConcreteChildData(int id, String text) {
            this.id = id;
            this.text = text;
        }
