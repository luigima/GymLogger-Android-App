...
public class WorkoutExercisesAdapter
        extends AbstractExpandableItemAdapter<WorkoutExercisesAdapter.MyGroupViewHolder, WorkoutExercisesAdapter.MyChildViewHolder>
        implements ExpandableDraggableItemAdapter<WorkoutExercisesAdapter.MyGroupViewHolder, WorkoutExercisesAdapter.MyChildViewHolder>,
        ExpandableSwipeableItemAdapter<WorkoutExercisesAdapter.MyGroupViewHolder, WorkoutExercisesAdapter.MyChildViewHolder> {
    ...
    public static class MyGroupViewHolder extends MyBaseViewHolder {
        ...
        public TextView textViewProgression;
        public ImageView imgViewExercise;


        public MyGroupViewHolder(View v) {
            super(v);
            mIndicator = (ExpandableItemIndicator) v.findViewById(R.id.indicator);
            textViewExerciseTitle = (TextView) v.findViewById(R.id.txtExerciseTitle);
            textViewProgression = (TextView) v.findViewById(R.id.txtProgression);
            imgViewExercise = (ImageView) v.findViewById(R.id.imgMuscles);
        }
    }
    ...
    public static class MyChildViewHolder extends MyBaseViewHolder {
        ...
        public MyChildViewHolder(View v) {
            ...
            textViewReps = (TextView) v.findViewById(R.id.column_reps);
            textViewWeight = (TextView) v.findViewById(R.id.column_weight);
        }
    }

    public WorkoutExercisesAdapter(
    ...
    public int getChildItemViewType(int groupPosition, int childPosition) {
        return childPosition == getChildCount(groupPosition) - 1 ? VIEW_TYPE_CHILD : VIEW_TYPE_HEAD;
    }

    @Override
    public MyGroupViewHolder onCreateGroupViewHolder(ViewGroup parent, int viewType) {
        final LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        final View v = inflater.inflate(R.layout.list_active_workout_exercise_item, parent, false);
    ...
    public MyChildViewHolder onCreateChildViewHolder(ViewGroup parent, int viewType) {
        final LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        final View v = inflater.inflate(R.layout.list_exercise_data_input_item, parent, false);
    ...
    public void onBindGroupViewHolder(MyGroupViewHolder holder, int groupPosition, int viewType) {
        ...
        holder.textViewExerciseTitle.setText(item.getText());
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0) ||
            ...
            if (isExpanded) {
                holder.textViewExerciseTitle.setEnabled(true);
            } else {
                holder.textViewExerciseTitle.setEnabled(false);
            }
        }
    ...
    public void onBindChildViewHolder(MyChildViewHolder holder, int groupPosition, int childPosition, int viewType) {
        ...
        // set text
        holder.textViewSet.setText(item.getText());
        ...
        if (isDragging) {
            if (viewType == VIEW_TYPE_CHILD) holder.mContainer.setVisibility(View.GONE);
        } else {
            if (viewType == VIEW_TYPE_CHILD) holder.mContainer.setVisibility(View.VISIBLE);
        }
    }
    ...
    public int onGetChildItemSwipeReactionType(MyChildViewHolder holder, int groupPosition, int childPosition, int x, int y) {
        ...
        if (getChildItemViewType(groupPosition, childPosition) == VIEW_TYPE_CHILD) {
            return Swipeable.REACTION_CAN_NOT_SWIPE_BOTH_H;
        }
    ...
    private static class GroupSwipeLeftResultAction extends SwipeResultActionMoveToSwipedDirection {
        ...
        GroupSwipeLeftResultAction(WorkoutExercisesAdapter adapter, int groupPosition) {
            mAdapter = adapter;
    ...
    private static class GroupSwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        GroupSwipeRightResultAction(WorkoutExercisesAdapter adapter, int groupPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
        }
    ...
    private static class GroupUnpinResultAction extends SwipeResultActionDefault {
        ...
        GroupUnpinResultAction(WorkoutExercisesAdapter adapter, int groupPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
        }
    ...
    private static class ChildSwipeLeftResultAction extends SwipeResultActionMoveToSwipedDirection {
        ...
        ChildSwipeLeftResultAction(WorkoutExercisesAdapter adapter, int groupPosition, int childPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
    ...
    private static class ChildSwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        ChildSwipeRightResultAction(WorkoutExercisesAdapter adapter, int groupPosition, int childPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
            mChildPosition = childPosition;
        }
    ...
    private static class ChildUnpinResultAction extends SwipeResultActionDefault {
        ...
        ChildUnpinResultAction(WorkoutExercisesAdapter adapter, int groupPosition, int childPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
            mChildPosition = childPosition;
        }
