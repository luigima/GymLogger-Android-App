package com.luigima.gymlogger.ui.base.advancedrecyclerview;
...
public abstract class AbstractExpandableDataProvider {
    ...
    public abstract long addGroupItem(int dataId, String title);
    public abstract void setGroupItem(int groupPosition, String text);

    public abstract long addChildItem(int groupPosition, String text, int exerciseId);
    public abstract long setChildItem(int groupPosition, int childPosition, String text, int exerciseId);
